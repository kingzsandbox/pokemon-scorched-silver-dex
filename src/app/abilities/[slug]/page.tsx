...
import { getAbilityBySlug, getAbilityDescription, getAbilityDisplayName } from "../../../lib/data/abilities";
...
export default async function AbilityDetailPage({ params }: AbilityDetailPageProps) {
  ...
  return (
    <main style={{ margin: "0 auto", maxWidth: "900px", padding: "40px 24px 64px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>{getAbilityDisplayName(ability)}</h1>
      <p style={{ color: "var(--text-muted)" }}>{getAbilityDescription(ability)}</p>
